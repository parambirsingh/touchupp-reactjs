                        ...
                        <div className="col-md-12">
                            ...
                            <div className="w-100">
                                ...
                                <div className="file file-upload mt-5 position-relative">
                                    <label htmlFor='input-file' className="w-100 cursor-pointer d-flex align-items-center justify-content-center flex-wrap">
                                    ...
                                    <input id='input-file' ref={image} onChange={(e) => handleChange(e)} type='file' />
                                </div>
                            </div>
                        </div>
                    </div>
